...
[승현 검토·정정 기록](docs/data/upa_review_20260919.md)과 [최신 논문 v6.0 검토본](docs/submission/ack_paper_v6_0.md)에 데이터 활용 한계를 반영했습니다. 제공기관 용어 확인은 대기 중입니다. 해기원 한바다호 AB-LOG는 수령해 요약표 내부 검산을 마쳤으며 연도는 2026년으로 확인됐고 일별 단위는 kL로 정정됐습니다. 밀도·기준 조건·집계 시간 정합성은 미확인입니다.
