...
현재 논문은 [v4.5](../submission/ack_paper_v4_5.md)이며 이 문서는 v3.0 당시 검증 근거를 보존한다. 저자 4명과 사용자 제공 소속 반영은 완료됐고 최종 순서·영문 표기·이메일은 미확정이다. 승현 원자료 검토는 [수령·정정 반영 완료](../data/upa_review_20260919.md), 민재 회신은 [수령·내용 검토 완료](minjae_domain_review_20260920.md)이며 원고·배포 웹 반영은 남아 있다. 해기원 실측 자료는 대기 중이다.
